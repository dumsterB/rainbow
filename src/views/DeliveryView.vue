<template>
  <footer class="footer">
    <a class="footer__contacts">Контакты +998 95 050 70 60 </a>
    <a href="https://www.facebook.com/rainbow.tj">
      <svg
      ...
      >
        ...
        ></path></svg
    ></a>
    <a href="https://instagram.com/rainbowtajikistan?igshid=YmMyMTA2M2Y="
      ><svg
        xmlns="http://www.w3.org/2000/svg"
        x="0px"
        y="0px"
